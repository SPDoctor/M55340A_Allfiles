...
namespace SQLBooksWebApp.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookID,Title,AuthorID,Published")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookID,Title,AuthorID,Published")] Book book)
        {
            if (id != book.BookID)
            {
                return NotFound();
